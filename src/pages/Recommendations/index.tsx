      ...
      <ScrollView>
        <Container>
          ...
          <Description>
            ...
            pandemia de COVID-19 devemos seguir as devidas recomendações para
            nós proteger e evitar o agravamento da pandemia.
          </Description>
          <TopicTitle>Compradores:</TopicTitle>
          <Topic>• Ao sair de casa utilize máscara.</Topic>
          <Topic>
            • Lembre-se sempre de respeitar o distanciamento social, o
            recomendado são 2 metros de distância.
          </Topic>
          <Topic>
            • Verifique o horário de funcionamento do estabelecimento.
          </Topic>
          <Topic>
            • Informe ao vendedor o que irá comprar, para obter informações de
            disponibilidade, e para que seja feita a organização e higienização
            da encomenda.
          </Topic>
          <Topic>
